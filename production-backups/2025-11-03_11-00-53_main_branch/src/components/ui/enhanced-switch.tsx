...
const variants = {
  default: {
    checked: "data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-blue-500 data-[state=checked]:to-blue-600 data-[state=checked]:shadow-blue-200",
    unchecked: "data-[state=unchecked]:bg-gray-200",
    thumb: "data-[state=checked]:shadow-blue-100",
    ring: "focus-visible:ring-blue-300"
  },
  success: {
    checked: "data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-green-500 data-[state=checked]:to-green-600 data-[state=checked]:shadow-green-200",
    unchecked: "data-[state=unchecked]:bg-gray-200",
    thumb: "data-[state=checked]:shadow-green-100",
    ring: "focus-visible:ring-green-300"
  },
  warning: {
    checked: "data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-yellow-500 data-[state=checked]:to-yellow-600 data-[state=checked]:shadow-yellow-200",
    unchecked: "data-[state=unchecked]:bg-gray-200",
    thumb: "data-[state=checked]:shadow-yellow-100",
    ring: "focus-visible:ring-yellow-300"
  },
  error: {
    checked: "data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-red-500 data-[state=checked]:to-red-600 data-[state=checked]:shadow-red-200",
    unchecked: "data-[state=unchecked]:bg-gray-200",
    ...
    <div className="flex items-center gap-3">
      ...
      <SwitchPrimitives.Root
        className={cn(
          ...
          // 悬停时的阴影增强
          "data-[state=checked]:hover:shadow-lg data-[state=unchecked]:hover:bg-gray-300",
          // 变体样式
