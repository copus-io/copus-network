...
export const UserProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // Demo user data for withdraw prototype
  const demoUser: User = {
    id: 999,
    username: "提现演示用户",
    email: "demo@copus.io",
    bio: "这是一个用于演示提现功能的虚拟用户",
    coverUrl: "https://images.unsplash.com/photo-1579546929518-9e396f3cc809",
    faceUrl: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face",
    namespace: "demo-user",
  ...
  useEffect(() => {
    ...
    if (savedUser && savedToken) {
      ...
      // If no saved user, automatically login with demo user for withdraw prototype
      console.log('🎭 Auto-logging in with demo user for withdraw prototype');
      setUser(demoUser);
      setToken('demo-token-for-withdraw-prototype');
      localStorage.setItem('copus_user', JSON.stringify(demoUser));
      localStorage.setItem('copus_token', 'demo-token-for-withdraw-prototype');
    }
