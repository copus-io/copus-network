...
export interface ArticleData {
  ...
  targetUrl?: string;
  website?: string;
  earnings?: number; // 收益金额，仅在自己的作品中显示
}
        ...
        return (
          <CardContent className="flex flex-col gap-[25px] py-5 px-[30px] flex-1">
            ...
            <div className="flex items-center justify-between mt-auto -mx-[30px] px-[30px]">
              ...
              {/* Earnings display - only for own articles */}
              {actions.showEarnings && article.earnings !== undefined && (
                <div className="flex items-center gap-2">
                  <span className="text-green-600">💰</span>
                  <span className="[font-family:'Lato',Helvetica] font-medium text-green-600 text-base tracking-[0] leading-[20.8px]">
                    {article.earnings.toFixed(2)} USDC
                  </span>
                </div>
              )}
