      ...
      <div className="flex w-full h-full relative flex-col items-center">
        <header className="flex items-start justify-between p-[30px] relative self-stretch w-full flex-[0_0_auto] bg-transparent">
          <div className="inline-flex items-center gap-[15px] relative flex-[0_0_auto]">
            ...
            <Link to="/discovery" className="relative w-fit [font-family:'Lato',Helvetica] font-bold text-dark-grey text-lg tracking-[0.90px] leading-[27px] whitespace-nowrap">
              Copus
            </Link>
        ...
        <main className="flex flex-col pt-5 px-[200px] relative flex-1 w-full max-w-[1440px] min-h-0 overflow-y-auto pb-[120px]">
          ...
          <div className="flex justify-between self-stretch w-full items-center relative flex-[0_0_auto] py-[30px] px-[200px] bg-[linear-gradient(0deg,rgba(224,224,224,0.2)_0%,rgba(224,224,224,0.2)_100%),linear-gradient(0deg,rgba(255,255,255,1)_0%,rgba(255,255,255,1)_100%)] fixed bottom-0 left-0 right-0">
            <div className="inline-flex items-center gap-5 relative flex-[0_0_auto]">
              <Button
                variant="outline"
