  ...
  return (
    <section className="flex flex-col items-center px-4 sm:px-8 lg:px-0 py-0 relative flex-1 grow w-full">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0 pt-0 pb-0 sm:pb-2.5 px-0 relative self-stretch w-full flex-[0_0_auto]">
              ...
              {hasEmail ? (
                <Button
                  ...
                  className="px-5 py-2 bg-red text-white rounded-[50px] hover:bg-red/90 transition-colors h-auto text-sm sm:text-base disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed"
                ...
                <Button
                  ...
                  className="px-5 py-2 rounded-[50px] border border-solid border-[#f23a00] bg-transparent text-red hover:bg-red/5 transition-colors h-auto font-bold text-sm sm:text-base"
                  disabled={loading}
                >
                  Bind Email
                </Button>
      ...
      <div className="flex items-start gap-4 px-3 sm:px-5 py-2 sm:py-[5px] relative self-stretch w-full flex-[0_0_auto] rounded-[15px] bg-gray-100">
        ...
        <div className="relative flex items-start w-28 sm:w-32 font-normal text-gray-600 text-xs sm:text-sm">
          Date
        </div>
      </div>
        ...
        {loading ? (
          ...
          transactions?.map((transaction) => {
            ...
            return (
              ...
              >
                <div className="flex flex-col w-[50%] sm:w-[60%] min-w-0 items-start justify-center gap-1 sm:gap-[5px] relative self-stretch">
                ...
                <div className="flex w-28 sm:w-32 items-center justify-start">
