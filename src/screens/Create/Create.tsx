          ...
          <div className="flex flex-col lg:flex-row items-start gap-[20px] sm:gap-[30px] lg:gap-[40px] xl:gap-[60px] w-full">
            ...
            <div className="flex items-center gap-3 w-full">
              ...
              >
                ...
                <span className="text-[#686868] text-[length:var(--p-l-font-size)] leading-[var(--p-l-line-height)] font-p-l [font-style:var(--p-l-font-style)] font-[number:var(--p-l-font-weight)] tracking-[var(--p-l-letter-spacing)]">Private</span>
              </div>
            </div>
