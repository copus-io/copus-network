  ...
  return (
    <section className="flex flex-col items-start gap-[15px] relative self-stretch w-full flex-[0_0_auto] px-4 lg:px-0">
      ...
      <div className="inline-flex items-center gap-5 pt-2.5 pb-0 px-0 relative flex-[0_0_auto]">
        ...
        <button
          className="relative w-[32px] h-[32px] cursor-pointer hover:opacity-80 transition-opacity flex items-center justify-center rounded-full border border-solid border-[#2191FB]"
          aria-label="Share space"
          type="button"
          onClick={onShare}
        >
          <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10.0243 18H15.96C16.8686 18 17.6043 17.2128 17.6043 16.2446C17.6043 16.1022 17.4886 15.9814 17.3529 15.9814C17.2186 15.9814 17.1014 16.1022 17.1014 16.2446C17.1014 16.9494 16.5286 17.5149 15.8586 17.5149H10.0243C9.35571 17.5149 8.78143 16.9494 8.78143 16.2446V10.1054C8.78143 9.402 9.35571 8.8365 10.0243 8.8365C10.127 8.8365 10.2107 8.7406 10.2107 8.6232C10.2107 8.5058 10.127 8.41 10.0243 8.41C9.11714 8.41 8.38 9.1972 8.38 10.1054V16.2446C8.38 17.1514 9.11714 17.9386 10.0243 17.9386V18Z" fill="#2191FB" />
            <path d="M15.1586 8.0454V9.7245C12.4929 9.8783 10.8543 11.346 10.0314 14.0829L9.84 14.7195L10.3629 14.308C12.2043 12.868 13.6343 12.3262 15.1586 12.5649V14.2938L19 11.1203L15.1586 8.0454ZM15.4071 12.1546C13.5471 11.7608 11.9514 12.5714 10.6757 13.4792C11.49 11.2529 12.91 10.1542 15.1214 10.0629L15.32 10.0505V8.864L17.9 11.1203L15.32 13.3752V12.1611L15.4071 12.1546Z" fill="#2191FB" />
          </svg>
        </button>
      </div>
    </section>
