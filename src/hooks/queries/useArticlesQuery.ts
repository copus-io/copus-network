...
// Infinite scroll article list query
...
// Article query hook with convenience methods (compatible with existing API)
export const useArticles = (initialParams: PageArticleParams = {}) => {
  ...
  return {
    ...
    loadMore: () => {
      // For pagination, use useInfiniteArticlesQuery instead
