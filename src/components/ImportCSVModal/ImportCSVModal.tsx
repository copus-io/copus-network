              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg px-4 py-3">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-amber-800">
                    <span className="font-medium">Note:</span> All imported items will be saved as <span className="font-semibold">private works</span>. You can change visibility to public from the work detail page after import.
                  </p>
                </div>
              </div>
