...
export const WalletSignInModal: React.FC<WalletSignInModalProps> = ({
  ...
  const walletOptions: WalletOption[] = [
    ...
    },
    {
      id: "trust",
      name: "Trust Wallet",
      icon: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1024 1024'%3E%3Cpath fill='%233375BB' d='M512 0l342 120v362c0 188-128 364-342 452C298 846 170 670 170 482V120L512 0z'/%3E%3Cpath fill='%23fff' d='M512 120c-85 0-153 68-153 153v171h102V273c0-28 23-51 51-51s51 23 51 51v171h102V273c0-85-68-153-153-153zm0 375H359v324c0 84 68 153 153 153s153-69 153-153V495H512z'/%3E%3C/svg%3E",
    },
    {
      id: "frame",
      name: "Frame",
      icon: "https://avatars.githubusercontent.com/u/38738442?s=200&v=4",
    },
  ];
