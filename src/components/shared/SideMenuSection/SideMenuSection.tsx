...
const IncomeIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg" className={`!w-[24px] !h-auto ${className}`} style={{ width: '24px', height: 'auto', minWidth: '24px' }}>
