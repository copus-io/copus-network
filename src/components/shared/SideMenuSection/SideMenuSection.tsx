...
const DiscoverIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg width="24" height="19" viewBox="0 0 30 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={`!w-[24px] !h-auto ${className}`} style={{ width: '24px', height: 'auto', minWidth: '24px' }}>
...
const TreasuryIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg width="16" height="23" viewBox="0 0 18 26" fill="none" xmlns="http://www.w3.org/2000/svg" className={`!w-[16px] !h-auto ${className}`} style={{ width: '16px', height: 'auto', minWidth: '16px' }}>
...
const NotificationIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg width="20" height="22" viewBox="0 0 24 26" fill="none" xmlns="http://www.w3.org/2000/svg" className={`!w-[20px] !h-auto ${className}`} style={{ width: '20px', height: 'auto', minWidth: '20px' }}>
...
const FollowingIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg width="22" height="22" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={`!w-[22px] !h-auto ${className}`} style={{ width: '22px', height: 'auto', minWidth: '22px' }}>
...
const IncomeIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg width="20" height="20" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg" className={`!w-[20px] !h-auto ${className}`} style={{ width: '20px', height: 'auto', minWidth: '20px' }}>
...
export const SideMenuSection = ({ activeItem }: SideMenuSectionProps): JSX.Element => {
  ...
  return (
    <aside className="hidden lg:flex flex-col h-screen w-[300px] fixed left-0 top-0 pt-[110px] px-[30px] pb-[15px]">
      <nav className="inline-flex items-center gap-2 px-5 py-[30px] bg-[#ffffff] flex-col relative flex-[0_0_auto] rounded-lg w-[240px]">
        {menuItems.map((item, index) => {
          ...
          return (
            <Button
              ...
              asChild
              variant="ghost"
              className={`flex items-center gap-3 px-5 py-2.5 relative self-stretch w-full flex-[0_0_auto] rounded-[15px] h-auto justify-start transition-colors hover:bg-gray-50 ${
                isActive
