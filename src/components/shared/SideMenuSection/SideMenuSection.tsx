...
const DiscoverIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg width="30" height="24" viewBox="0 0 30 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={`!w-[30px] !h-auto ${className}`} style={{ width: '30px', height: 'auto', minWidth: '30px' }}>
...
const TreasuryIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg width="20" height="29" viewBox="0 0 18 26" fill="none" xmlns="http://www.w3.org/2000/svg" className={`!w-[20px] !h-auto ${className}`} style={{ width: '20px', height: 'auto', minWidth: '20px' }}>
...
const NotificationIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg width="24" height="26" viewBox="0 0 24 26" fill="none" xmlns="http://www.w3.org/2000/svg" className={`!w-[24px] !h-auto ${className}`} style={{ width: '24px', height: 'auto', minWidth: '24px' }}>
...
const FollowingIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={`!w-[28px] !h-auto ${className}`} style={{ width: '28px', height: 'auto', minWidth: '28px' }}>
...
const IncomeIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={`!w-[24px] !h-auto ${className}`} style={{ width: '24px', height: 'auto', minWidth: '24px' }}>
