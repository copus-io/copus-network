          ...
          <CardContent className="flex flex-col gap-[20px] py-5 px-[30px] flex-1">
            ...
            <div className="flex items-center justify-between -mx-[30px] px-[30px]">
              ...
              <div className="flex items-center gap-4">
                ...
                {/* Earnings display for my share cards */}
                {(actions.showEarningsPreview || article.isEarningsPreview) && article.totalEarnings !== undefined && (
                  <div className="inline-flex items-center gap-2">
                    <span className="text-green-600">💰</span>
                    <span className="[font-family:'Lato',Helvetica] font-medium text-green-600 text-center tracking-[0] leading-[20.8px]" style={{ fontSize: '1rem' }}>
