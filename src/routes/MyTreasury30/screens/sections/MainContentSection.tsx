                ...
                >
                  ...
                  >
                    <CardContent className="flex flex-col items-start justify-center gap-5 w-full rounded-[100px] p-0">
                      ...
                      >
                        <Badge
                          className="inline-flex items-center gap-[5px] px-2.5 py-2 rounded-[50px] border border-solid h-auto"
                          style={{
                        ...
                        >
                          <span
                            className={`w-fit mt-[-1.00px] [font-family:'Lato',Helvetica] font-semibold text-${item.categoryColor} text-sm tracking-[0] leading-[14px] whitespace-nowrap`}
                          >
                            {item.category}
                          </span>
                        </Badge>
