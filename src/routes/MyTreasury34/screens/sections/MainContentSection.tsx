...
const collectionItems = [
  {
    ...
    coverImage: "https://c.animaapp.com/mfw5a2xo4LOvv6/img/cover.png",
    title: "Window Swap",
    description: "Explore the world through window, what's inside?",
    url: "productdesign.com",
    userImage: "https://c.animaapp.com/mfw5a2xo4LOvv6/img/-profile-image-1.png",
    userName: "User Name",
    date: "Nov 15, 2022",
    treasureCount: "999",
  ...
  },
  {
    ...
    coverImage: "https://c.animaapp.com/mfw5a2xo4LOvv6/img/cover-1.png",
    title: "Window Swap",
    description: "Explore the world through window, what's inside?",
    url: "productdesign.com",
    userImage: "https://c.animaapp.com/mfw5a2xo4LOvv6/img/-profile-image-1.png",
...
export const MainContentSection = (): JSX.Element => {
  return (
    <div className="flex flex-col items-start gap-[30px] py-5 min-h-screen">
      <div className="flex flex-col items-start w-full">
        ...
        <div className="gap-10 pl-5 pr-10 py-0 mt-[-46px] flex items-start w-full">
          <Avatar className="w-[100px] h-[100px] border-2 border-solid border-[#ffffff]">
            <AvatarImage
              src="https://c.animaapp.com/mfw5a2xo4LOvv6/img/profile.png"
              alt="Profile"
          ...
          <div className="flex flex-col items-start gap-5 pt-[60px] pb-0 px-0 flex-1 grow">
            <div className="inline-flex flex-col items-start justify-center">
              <div className="inline-flex items-center gap-[15px]">
                ...
                <ShareIcon className="w-5 h-5 text-dark-grey" />
              </div>
                  ...
                  >
                    <div className="gap-[5px] inline-flex items-center">
                      <img
                        ...
                        alt="Logo wrap"
                        src="https://c.animaapp.com/mfw5a2xo4LOvv6/img/logo-wrap.svg"
                      />
      ...
      <div className="flex flex-col items-start gap-[30px] w-full mb-[-42.00px]">
        <Tabs defaultValue="collection" className="w-full">
                  ...
                  >
                    <CardContent className="flex flex-col items-start justify-center gap-5 w-full rounded-[100px] p-0">
                      ...
                      >
                        ...
                        <div className="flex flex-col items-end gap-2.5 self-stretch w-full">
                          <div className="inline-flex items-start gap-[5px] px-2.5 py-[5px] bg-[#ffffffcc] rounded-[15px] overflow-hidden">
                            <span className="flex items-center justify-center mt-[-1.00px] [font-family:'Lato',Helvetica] font-medium text-blue text-sm text-right tracking-[0] leading-[18.2px] whitespace-nowrap">
                              {item.url}
                            </span>
                          </div>
                        </div>
                      ...
                      <div className="flex flex-col items-start gap-[15px] w-full">
                        <h2 className="self-stretch mt-[-1.00px] [font-family:'Lato',Helvetica] font-semibold text-dark-grey text-2xl tracking-[0] leading-9">
                          {item.title}
                        </h2>
                ...
                {item.userName}
                    ...
                    <div className="flex items-center justify-between w-full">
                      <div className="gap-[15px] inline-flex items-center">
                        <div className="inline-flex items-center gap-2">
                          <img
                            ...
                            alt="Treasure icon"
                            src="https://c.animaapp.com/mfw5a2xo4LOvv6/img/treasure-icon.svg"
                          />
                        ...
                        <div className="inline-flex items-center gap-2">
                          <img
                            className="w-5 h-3.5"
                            alt="Ic view"
                            src="https://c.animaapp.com/mfw5a2xo4LOvv6/img/ic-view.svg"
                          />
                      ...
                      <img
                        ...
                        alt="Branch it"
                        src="https://c.animaapp.com/mfw5a2xo4LOvv6/img/branch-it.svg"
                      />
                    </div>
                  </Card>
                </div>
          ...
          <TabsContent value="share" className="mt-[30px]">
            <div className="flex items-start gap-20 w-full">
              <p className="text-dark-grey">My share content would go here</p>
            </div>
          </TabsContent>
        </Tabs>
      </div>
