    ...
    <header className="flex items-center justify-between p-[30px] w-full bg-transparent">
      <div className="flex items-center gap-[15px]">
        <div className="flex w-[45px] h-[45px] items-center justify-center rounded-full bg-red">
          <img
            ...
            src="https://c.animaapp.com/mfvyjo4ej1WzJf/img/ic-fractopus-open.svg"
          />
        </div>
      ...
      <div className="flex items-center gap-5">
        ...
        >
          ...
          <span className="[font-family:'Lato',Helvetica] font-semibold text-lg leading-[27px] whitespace-nowrap">
            Create
          </span>
        </Button>

        <BellIcon className="w-[47px] h-[47px] text-dark-grey" />
