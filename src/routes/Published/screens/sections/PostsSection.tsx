        ...
        {leftColumnPosts.map((post, index) => (
          ...
          >
            <CardContent className="flex flex-col items-start justify-center gap-5 self-stretch w-full rounded-[100px] p-0">
              ...
              >
                <Badge
                  className={`px-2.5 py-2 inline-flex items-center gap-[5px] rounded-[50px] border border-solid ${post.categoryColor}`}
                >
                  <span
                    className={`${post.fontFamily || "[font-family:'Lato',Helvetica]"} font-semibold text-sm tracking-[0] leading-[14px] whitespace-nowrap`}
                  >
                    {post.category}
                  </span>
                </Badge>
