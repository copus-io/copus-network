    ...
    <div className="w-full min-h-screen flex bg-[linear-gradient(0deg,rgba(224,224,224,0.15)_0%,rgba(224,224,224,0.15)_100%),linear-gradient(0deg,rgba(255,255,255,1)_0%,rgba(255,255,255,1)_100%)]">
      <div className="flex w-full h-screen relative flex-col items-center">
        <header className="flex items-start justify-between px-[30px] py-5 relative w-full flex-[0_0_auto] bg-transparent">
          ...
          <div className="inline-flex items-center justify-end relative flex-[0_0_auto] rounded-[10px_10px_0px_0px]">
        ...
        <div className="inline-flex items-center gap-2.5 relative flex-1 grow">
          <Card className="w-[480px] bg-white rounded-lg border-0 shadow-none">
            <CardContent className="flex flex-col items-center justify-center gap-[50px] px-[50px] py-[60px]">
              <div className="flex flex-col items-start gap-[15px] relative self-stretch w-full flex-[0_0_auto]">
                <div className="relative self-stretch mt-[-1.00px] font-h-3 font-[number:var(--h-3-font-weight)] text-off-black text-[length:var(--h-3-font-size)] text-center tracking-[var(--h-3-letter-spacing)] leading-[var(--h-3-line-height)] [font-style:var(--h-3-font-style)]">
                  Join Copus
                </div>

                <div className="relative self-stretch font-h-4 font-[number:var(--h-4-font-weight)] text-dark-grey text-[length:var(--h-4-font-size)] text-center tracking-[var(--h-4-letter-spacing)] leading-[var(--h-4-line-height)] [font-style:var(--h-4-font-style)]">
              ...
              <div className="flex flex-col items-center justify-center gap-[30px] relative self-stretch w-full flex-[0_0_auto]">
                <Tabs defaultValue="login" className="w-full">
                  ...
                  <TabsContent value="login" className="mt-[30px]">
                    ...
                    <Button className="flex items-center justify-center gap-[30px] px-10 py-2.5 relative self-stretch w-full flex-[0_0_auto] rounded-[100px] border border-solid border-[#f23a00] bg-transparent hover:bg-transparent mt-[30px] h-auto">
